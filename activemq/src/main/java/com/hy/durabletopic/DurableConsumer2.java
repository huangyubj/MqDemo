 ...
 * Project: MqDemo
 */
public class DurableConsumer2 extends Consumer {
    public DurableConsumer2() throws JMSException {
        super();
    }
    ...
    protected void init() throws JMSException {
        ...
        connection.setClientID("durable_client2");
        connection.start();
    ...
    public static void main(String[] args) throws JMSException {
        DurableConsumer2 producer1 = new DurableConsumer2();
        try {
